     ...
     <!-- DESPESA -->
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Inserir Receita</h3>
                        </div>
                        <div class="card-body">
                            <?php $this->load->view('admin/includes/_messages.php') ?>

                <?php echo form_open(base_url('admin/financeiro/add_receita'), 'class="form-horizontal"'); ?> 
                <?php "<br />"; ?>
                            <!-- Date range -->
                  ...
                  <div class="form-group">
                <div class="col-md-12">
                        <input type="submit" name="submit" value="Gravar receita" class="btn btn-primary pull-right">
                    </div></div>
