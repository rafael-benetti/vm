              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <select name="status" class="form-control">
                    ...
                    <option value="1" <?= ($admin['is_active'] == 1)?'selected': '' ?> >Ativo</option>
                    <option value="0" <?= ($admin['is_active'] == 0)?'selected': '' ?>>Desativado</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                <label for="role" class="col-md-2 control-label">Selecione a permissão*</label>
