...
<script>
    ...
    var table = $('#na_datatable').DataTable({
        ...
        "ajax": "<?= base_url('admin/admin/datatable_log_json/' . $user_id . '/'.$item_id.'') ?>",
                            ...
                            <h3>Insumo: <b><?php echo $item->item; ?></b> </h3>
                                        ...
                                        <select name="tipo_operacao" style="width:100%" class="js-example-basic-single"id="item" >
                                         ...
                                         <div class="input-group">
                                               ...
                                               <input type="hidden" name="user_id" class="form-control" id="id_maquina" value="<?php echo $user_id; ?>" >
                                               <input type="hidden" name="item_id" class="form-control" id="item" value="<?php echo $item_id; ?>" >
