                    ...
                    <li id="financeiro" class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="<?= base_url('admin/financeiro/receita'); ?>" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="<?= base_url('admin/financeiro/despesa'); ?>" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="<?= base_url('admin/financeiro'); ?>" class="nav-link">
