        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="d-inline-block">
                    ...
                    <h3 class="card-title"><i class="fa fa-list"></i>Estoque Máquina <b> <?php echo strtoupper($machine['nome_tipo']); ?></b></h3>
...
<script>
    ...
    var table = $('#na_datatable').DataTable({
        ...
        "ajax": "<?= base_url('admin/machines/datatable_log_json/' . $id_maquina . '') ?>",
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <?php $this->load->view('admin/includes/_messages.php') ?>
                ...
                <?php echo form_open(base_url('admin/machines/add_log'), 'class="form-horizontal" '); ?> 
      ...
      <?php "<br />"; ?>
                ...
                <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <h3>Insumo: <b><?php echo $item['item']; ?></b> </h3>
                                        ...
                                        <select name="tipo_operacao" style="width:100%" class="js-example-basic-single"id="item" >
                                         ...
                                         <div class="input-group">
                                               ...
                                               <input type="hidden" name="id_maquina" class="form-control" id="id_maquina" value="<?php echo $id_maquina; ?>" >
